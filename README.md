...
_Ebe Kartus is currently one of the Systems Librarians at Libraries Tasmania. Previously she was in the position of Team Leader, Serials Cataloguing Team at the National Library of New Zealand where she led the Team in the implementation of Official RDA for serial works and archived websites. She has worked in a variety of Library environments in Australia. She is a past member of the RSC as the ORDAC representative and the Wider Community Engagement Officer and a current member of the Technical Working Group._
<br><br>
**-Clair Kronk [Superraptor](https://github.com/Superraptor), Triplestore Contributor**<br>
_Clair Kronk, PhD (she/her) is an Assistant Professor in the Institute for Health Equity Research (IHER) in the Department of Population Health Science & Policy (PHSP), with secondary appointments in the Department of Artificial Intelligence and Human Health (AIHH) and the Department of Medicine's Division of Data-Driven Medicine (D3M). Her research as an informaticist and health equity scholar focuses primarily on how data standards, vocabularies, and policies impact health. She is the creator and primary curator of the Gender, Sex, and Sexual Orientation (GSSO) ontology, which has developed into lgbtDB, the largest LGBTQIA+-specific database on the internet. Kronk has contributed to a number of international sex- and gender-related standards, and continues to work on developing methodologies in community-based algorithm development._
<br><br>
